...
- the base toolbar is a native-popover-backed floating panel anchored near the edited node
- toolbar drag has been temporarily removed while the phase 1.8 Q2 rebuild switches to the focused-panel host pattern
...
- the link panel follows the base toolbar position instead of staying anchored to the original text node position
