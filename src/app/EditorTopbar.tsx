...
export function EditorTopbar({
  ...
  onExportJson: () => void;
  onExportSite: () => void;
  onOpenSettingsSection: (section: 'display' | 'defaults' | 'fonts' | 'advanced') => void;
        ...
        <Menubar className="min-w-0 flex-1">
          <MenubarMenu id="settings">
            ...
            <MenubarContent>
              ...
              <MenubarSeparator />
              <MenubarPanelLinkItem onClick={() => onOpenSettingsSection('display')}>UI</MenubarPanelLinkItem>
              <MenubarPanelLinkItem onClick={() => onOpenSettingsSection('defaults')}>Defaults</MenubarPanelLinkItem>
              <MenubarPanelLinkItem onClick={() => onOpenSettingsSection('fonts')}>Fonts</MenubarPanelLinkItem>
              <MenubarPanelLinkItem onClick={() => onOpenSettingsSection('advanced')}>Advanced</MenubarPanelLinkItem>
            </MenubarContent>
          </MenubarMenu>
          ...
          <MenubarMenu id="view">
            ...
            <MenubarContent>
              <MenubarSubmenu label="Theme">
                <MenubarPanelLinkItem onClick={() => onOpenSettingsSection('display')}>Customize</MenubarPanelLinkItem>
                <MenubarSeparator />
                <MenubarGroupLabel>Light</MenubarGroupLabel>
                {EDITOR_LIGHT_THEME_OPTIONS.map((option) => (
                  <MenubarItem
                    key={option.value}
                    selected={resolvedTheme === 'light' && lightTheme === option.value}
                ...
                {EDITOR_DARK_THEME_OPTIONS.map((option) => (
                  <MenubarItem
                    key={option.value}
                    selected={resolvedTheme === 'dark' && darkTheme === option.value}
              ...
              <MenubarCheckboxItem checked={showGridLanes} onCheckedChange={onToggleShowGridLanes}>
                Show grid
              </MenubarCheckboxItem>
              <MenubarToggleWithMoreItem
                checked={snapEnabled}
              ...
              <MenubarCheckboxItem checked={showDebugInfo} onCheckedChange={onToggleShowDebugInfo}>
                Show debug info
              </MenubarCheckboxItem>
              ...
              <MenubarCheckboxItem
                checked={layersOpen}
                shortcut={getShortcutLabel('toggleLayersPanel', shortcutPlatform)}
              ...
              <MenubarCheckboxItem
                checked={pagesOpen}
                shortcut={getShortcutLabel('togglePagesPanel', shortcutPlatform)}
          ...
          <MenubarMenu id="help">
            ...
            <MenubarContent>
              <MenubarItem shortcut={getShortcutLabel('showShortcutHelp', shortcutPlatform)} onClick={onOpenShortcuts}>
                Shortcuts
              </MenubarItem>
              <MenubarPanelLinkItem onClick={() => onOpenDocumentation(DOCUMENTATION_ENTRY_ID)}>
                Documentation
              </MenubarPanelLinkItem>
              <MenubarPanelLinkItem onClick={() => {
                window.location.hash = '/design-system';
              }}>
                Design system showcase
              </MenubarPanelLinkItem>
              <MenubarPanelLinkItem onClick={onOpenAbout}>About</MenubarPanelLinkItem>
            </MenubarContent>
          </MenubarMenu>
        </Menubar>
