...
describe("panels/inspector/content section rows", () => {
	...
	it("renders expanded SVG stroke controls and separators", () => {
		...
		expect(markup).toContain('data-separated="true"');
		expect(markup).toContain(">Stroke size<");
		...
		expect(markup).toContain('aria-label="Round cap"');
		expect(markup).toContain('aria-label="Square cap"');
		expect(markup).toContain(">Join<");
		expect(markup).toContain(">SVG stroke join<");
		expect(markup).toContain('aria-label="Miter join"');
		expect(markup).toContain('aria-label="Bevel join"');
