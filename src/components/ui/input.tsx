  ...
  ({ className, type, value, onChange, onFocus, onBlur, ...props }, ref) => {
    ...
    return (
      <input
        ...
        className={cn(
          'flex h-9 w-full min-w-0 rounded-md border px-3 py-1 text-sm shadow-sm transition-[color,box-shadow,border-color] outline-none placeholder:text-slate-400 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50',
          className,
        )}
        ref={ref}
        {...props}
