...
export const PRESET_METADATA: Record<string, PresetMetadata> = {
  ...
  // ── Scroll ───────────────────────────────────────────────────────────────────
  ArcScroll: { preset: 'ArcScroll', label: 'Arc', description: 'Element arcs along a curved path as the page scrolls.', category: 'scroll' },
  BlurScroll: { preset: 'BlurScroll', label: 'Blur', description: 'Element transitions between blurred and sharp as you scroll.', category: 'scroll' },
  FadeScroll: { preset: 'FadeScroll', label: 'Fade', description: 'Element fades in or out as it moves through the viewport.', category: 'scroll' },
  FlipScroll: { preset: 'FlipScroll', label: 'Flip', description: 'Element flips on a 3D axis driven by scroll position.', category: 'scroll' },
  GrowScroll: { preset: 'GrowScroll', label: 'Grow', description: 'Element scales up from small to full size as you scroll.', category: 'scroll' },
  MoveScroll: { preset: 'MoveScroll', label: 'Move', description: 'Element translates along an angle tied to scroll progress.', category: 'scroll' },
  PanScroll: { preset: 'PanScroll', label: 'Pan', description: 'Element pans horizontally relative to vertical scroll.', category: 'scroll' },
  ParallaxScroll: { preset: 'ParallaxScroll', label: 'Parallax', description: 'Element moves at a different speed than the scroll, creating depth.', category: 'scroll' },
  RevealScroll: { preset: 'RevealScroll', label: 'Reveal', description: 'Element is progressively revealed by a wipe as you scroll.', category: 'scroll' },
  ShapeScroll: { preset: 'ShapeScroll', label: 'Shape', description: 'Element is masked by an expanding geometric shape tied to scroll.', category: 'scroll' },
  ShrinkScroll: { preset: 'ShrinkScroll', label: 'Shrink', description: 'Element scales down from full size as you scroll.', category: 'scroll' },
  ShuttersScroll: { preset: 'ShuttersScroll', label: 'Shutters', description: 'Element opens like blinds driven by scroll position.', category: 'scroll' },
  SkewPanScroll: { preset: 'SkewPanScroll', label: 'Skew Pan', description: 'Element skews and pans sideways as you scroll.', category: 'scroll' },
  SlideScroll: { preset: 'SlideScroll', label: 'Slide', description: 'Element slides in from a direction driven by scroll progress.', category: 'scroll' },
  Spin3dScroll: { preset: 'Spin3dScroll', label: 'Spin 3D', description: 'Element rotates in 3D space as the page scrolls.', category: 'scroll' },
  SpinScroll: { preset: 'SpinScroll', label: 'Spin', description: 'Element spins flat as it travels through the viewport.', category: 'scroll' },
  StretchScroll: { preset: 'StretchScroll', label: 'Stretch', description: 'Element stretches along one axis tied to scroll position.', category: 'scroll' },
  TiltScroll: { preset: 'TiltScroll', label: 'Tilt', description: 'Element tilts with parallax depth driven by scroll.', category: 'scroll' },
  TurnScroll: { preset: 'TurnScroll', label: 'Turn', description: 'Element turns like a page as you scroll through it.', category: 'scroll' },

  // ── Mouse ────────────────────────────────────────────────────────────────────
  AiryMouse: { preset: 'AiryMouse', label: 'Airy', description: 'Element drifts lightly after the pointer with an airy lag.', category: 'mouse' },
  BlobMouse: { preset: 'BlobMouse', label: 'Blob', description: 'Element morphs and scales like a blob following the cursor.', category: 'mouse' },
  BlurMouse: { preset: 'BlurMouse', label: 'Blur', description: 'Element blurs and shifts in response to pointer movement.', category: 'mouse' },
  BounceMouse: { preset: 'BounceMouse', label: 'Bounce', description: 'Element bounces elastically toward the pointer position.', category: 'mouse' },
  CustomMouse: { preset: 'CustomMouse', label: 'Custom', description: 'Custom pointer-driven animation with user-defined parameters.', category: 'mouse' },
  ScaleMouse: { preset: 'ScaleMouse', label: 'Scale', description: 'Element scales up or down based on pointer proximity.', category: 'mouse' },
  SkewMouse: { preset: 'SkewMouse', label: 'Skew', description: 'Element skews in the direction the pointer is moving.', category: 'mouse' },
  SpinMouse: { preset: 'SpinMouse', label: 'Spin', description: 'Element rotates as the pointer moves across it.', category: 'mouse' },
  SwivelMouse: { preset: 'SwivelMouse', label: 'Swivel', description: 'Element pivots around a fixed axis tracking the pointer.', category: 'mouse' },
  Tilt3DMouse: { preset: 'Tilt3DMouse', label: 'Tilt 3D', description: 'Element tilts in 3D space following pointer position.', category: 'mouse' },
  Track3DMouse: { preset: 'Track3DMouse', label: 'Track 3D', description: 'Element translates in 3D depth tracking the cursor.', category: 'mouse' },
  TrackMouse: { preset: 'TrackMouse', label: 'Track', description: 'Element follows the pointer position directly.', category: 'mouse' },
};
